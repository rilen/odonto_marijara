...
const Agendamento = () => {
  ...
  const handlePacienteSelectChange = (e) => {
    ...
    const selectedPaciente = pacientes.find(p => p.id === parseInt(id));
    setNewEvent({
      ...newEvent,
      pacienteId: id,
          ...
          <div className="mb-4">
            ...
            {pacientes.length === 0 && (
              <p className="text-sm text-gray-600 mt-2">
                Nenhum paciente encontrado. <a href="/contatos" className="text-blue-500 hover:underline">Cadastre um novo paciente aqui.</a>
              </p>
            )}
          </div>
